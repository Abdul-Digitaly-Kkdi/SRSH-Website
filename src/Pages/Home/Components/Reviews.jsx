                ...
                >
                    {Reviews.map((item, index) => (
                        <SwiperSlide key={index}>
                            <div className="group bg-white border border-gray-300 rounded-xl p-6 transition-all duration-500 w-full hover:border-rose-300 hover:shadow-sm">
                                <div className="mb-7 flex items-center gap-2 text-amber-500">
                                ...
                                <p className="text-base text-gray-600 leading-6 transition-all duration-500 group-hover:text-gray-800 pb-8">
                                    {item.text}
                                </p>
