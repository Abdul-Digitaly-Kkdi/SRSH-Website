            ...
            >
                {slides.map((slide, idx) => (
                    <SwiperSlide key={idx}>
                        ...
                        >
                            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-start px-6 md:px-20 text-white text-left">
